...
import javaoverride.util.LinkedHashSet;
import javaoverride.util.List;
import javaoverride.util.Optional;
import javaoverride.util.PriorityQueue;
import javaoverride.util.Spliterator;
import javaoverride.util.stream.Collector;
import javaoverride.util.stream.DoubleStream;
import javaoverride.util.stream.IntStream;
import javaoverride.util.stream.LongStream;
