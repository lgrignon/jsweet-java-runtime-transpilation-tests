...
import javaoverride.util.LinkedHashMap;
 ...
 * order. <a href=
 * "http://javaoverride.sun.com/j2se/1.5.0/docs/api/java/util/LinkedHashMap.html">[Sun
 * docs]</a>
 *
 * @param <K>
 *            key type.
...
public class LinkedHashMap<K, V> extends HashMap<K, V> implements Map<K, V> {
	...
	private final class EntrySet extends AbstractSet<Map.Entry<K, V>> {
		...
		public java.util.Iterator<Map.Entry<K, V>> iterator() {
			return IterableHelper.castIteratorToLang(new EntryIterator());
		}
