 ...
 * method of <tt>String</tt> or the javaoverride.util.regex package instead.
 * <p>
 ...
 *
 * @author  unascribed
 * @see     javaoverride.io.StreamTokenizer
 * @since   JDK1.0
 */
public
class StringTokenizer implements Enumeration<Object> {
     ...
     * @see     javaoverride.util.StringTokenizer#hasMoreTokens()
     */
     ...
     *               tokenizer's string.
     * @see        javaoverride.util.Enumeration
     * @see        javaoverride.util.StringTokenizer#nextToken()
     */
