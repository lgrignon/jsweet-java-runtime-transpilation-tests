...
import javaoverride.util.EnumMap;
...
/**
 * A {@link javaoverride.util.Map} of {@link Enum}s. <a
 * href="http://javaoverride.sun.com/j2se/1.5.0/docs/api/java/util/EnumMap.html">[Sun
 * docs]</a>
 *
 * @param <K> key type
 * @param <V> value type
...
public class EnumMap<K extends Enum<K>, V> extends AbstractMap<K, V> {
  ...
  private final class EntrySetIterator implements Iterator<Entry<K, V>> {
    private java.util.Iterator<K> it = keySet.iterator();
    private K key;
