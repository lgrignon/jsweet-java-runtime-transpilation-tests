 ...
 * <a href="http://javaoverride.sun.com/j2se/1.5.0/docs/api/java/util/AbstractMap.html">
 * [Sun docs]</a>
 *
 * @param <K>
 *            the key type.
...
public abstract class AbstractMap<K, V> implements Map<K, V> {
	...
	public Set<K> keySet() {
		return new AbstractSet<K>() {
			...
			public java.util.Iterator<K> iterator() {
				final java.util.Iterator<Entry<K, V>> outerIter = entrySet().iterator();
				return IterableHelper.castIteratorToLang(new Iterator<K>() {
					@Override
	...
	public Collection<V> values() {
		return new AbstractCollection<V>() {
			...
			public java.util.Iterator<V> iterator() {
				final java.util.Iterator<Entry<K, V>> outerIter = entrySet().iterator();
				return IterableHelper.castIteratorToLang(new Iterator<V>() {
					@Override
					public boolean hasNext() {
						return outerIter.hasNext();
					}
	...
	private Entry<K, V> implFindEntry(Object key, boolean remove) {
		for (java.util.Iterator<Entry<K, V>> iter = entrySet().iterator(); iter.hasNext();) {
