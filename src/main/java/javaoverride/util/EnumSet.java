...
import javaoverride.util.EnumSet;
...
/**
 * A {@link javaoverride.util.Set} of {@link Enum}s. <a href=
 * "http://javaoverride.sun.com/j2se/1.5.0/docs/api/java/util/EnumSet.html">[Sun
 * docs]</a>
 *
...
public abstract class EnumSet<E extends Enum<E>> extends AbstractSet<E> {
	 ...
	 * This is because declaring an EnumSet.add(E) causes hosted mode to bind to the
	 * tighter method rather than the bridge method; but the tighter method isn't
	 * available in the real JRE.
	 */
	static final class EnumSetImpl<E extends Enum<E>> extends EnumSet<E> {
		private class IteratorImpl implements Iterator<E> {
			 ...
			 * last is the index of the item that was returned on the previous call to
			 * next(), -1 if no such item exists.
			 */
		...
		public java.util.Iterator<E> iterator() {
			return IterableHelper.castIteratorToLang(new IteratorImpl());
		}
	...
	public static <E extends Enum<E>> EnumSet<E> copyOf(Collection<E> c) {
		...
		java.util.Iterator<E> iterator = c.iterator();
