...
import javaoverride.util.NavigableMap;
import javaoverride.util.NavigableSet;
...
abstract class AbstractNavigableMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V> {
  ...
  class EntrySet extends AbstractSet<Entry<K, V>> {
    ...
    public java.util.Iterator<Entry<K, V>> iterator() {
      return IterableHelper.castIteratorToLang(entryIterator());
    }
  ...
  private static final class NavigableKeySet<K, V> extends AbstractSet<K>
    ...
    public java.util.Iterator<K> iterator() {
      final java.util.Iterator<Entry<K, V>> entryIterator = map.entrySet().iterator();
