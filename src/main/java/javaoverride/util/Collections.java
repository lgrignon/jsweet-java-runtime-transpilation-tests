...
import javaoverride.util.AbstractList;
import javaoverride.util.AbstractMap;
import javaoverride.util.AbstractQueue;
import javaoverride.util.AbstractSet;
...
import javaoverride.util.Comparators;
import javaoverride.util.Deque;
...
public class Collections {
	...
	private static final class EmptyList extends AbstractList implements RandomAccess, Serializable {
		...
		public java.util.Iterator iterator() {
			return IterableHelper.castIteratorToLang(emptyIterator());
		}
	...
	static class UnmodifiableCollection<T> implements Collection<T> {
		...
		public java.util.Iterator<T> iterator() {
			Iterator<? extends T> originIterator = IterableHelper.castIteratorToOverride(coll.iterator());
			return IterableHelper.castIteratorToLang(new UnmodifiableCollectionIterator<T>(originIterator));
		}
	 ...
	 *         the array if the searched value is larger than all elements in the
	 *         array) minus 1 (to ensure error returns are negative)
	 * @throws ClassCastException if <code>key</code> and <code>sortedList</code>'s
	 *                            elements cannot be compared by
	...
	public static <T> Enumeration<T> enumeration(Collection<T> c) {
		final java.util.Iterator<T> it = c.iterator();
	...
	public static <T> T max(Collection<? extends T> coll, Comparator<? super T> comp) {
		...
		java.util.Iterator<? extends T> it = coll.iterator();
