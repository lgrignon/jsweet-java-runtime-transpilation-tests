...
import static javaoverride.util.ConcurrentModificationDetector.checkStructuralChange;
import static javaoverride.util.ConcurrentModificationDetector.recordLastKnownStructure;
 ...
 * <a href="http://javaoverride.sun.com/j2se/1.5.0/docs/api/java/util/HashMap.html">[Sun
 * docs]</a>
 *
 * @param <K>
 *            key type
...
abstract class AbstractHashMap<K, V> extends AbstractMap<K, V> {
	...
	private final class EntrySet extends AbstractSet<Entry<K, V>> {
		...
		public java.util.Iterator<Entry<K, V>> iterator() {
			return IterableHelper.castIteratorToLang(new EntrySetIterator());
		}
	...
	private final class EntrySetIterator implements Iterator<Entry<K, V>> {
		private java.util.Iterator<Entry<K, V>> stringMapEntries;
		private java.util.Iterator<Entry<K, V>> current;
		private java.util.Iterator<Entry<K, V>> last;
