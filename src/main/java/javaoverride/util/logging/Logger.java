 ...
 * the License.
 */
package javaoverride.util.logging;

import javaoverride.util.logging.Handler;
import javaoverride.util.logging.Level;
import javaoverride.util.logging.LogManager;
import javaoverride.util.logging.LogRecord;
import javaoverride.util.logging.Logger;

import javaoverride.util.ArrayList;
import javaoverride.util.List;

/**
 *  An emulation of the javaoverride.util.logging.Logger class. See
 *  <a href="http://javaoverride.sun.com/j2se/1.4.2/docs/api/java/util/logging/Logger.html">
