 ...
 * the License.
 */
package javaoverride.sql;

import javaoverride.sql.Date;
import javaoverride.sql.Time;
import javaoverride.sql.Timestamp;

/**
 * An implementation of javaoverride.sql.Timestame. Derived from
 * http://javaoverride.sun.com/j2se/1.5.0/docs/api/java/sql/Timestamp.html. This is
 * basically just regular Date decorated with a nanoseconds field.
 */
public class Timestamp extends javaoverride.util.Date {
  ...
  @Override
  public int compareTo(javaoverride.util.Date o) {
  ...
  public boolean equals(Object ts) {
    // Timestamps can't be compared to javaoverride.util.Date
