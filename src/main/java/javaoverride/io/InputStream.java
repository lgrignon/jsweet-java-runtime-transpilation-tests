 ...
 * ({@link FileInputStream}), the network ({@link javaoverride.net.Socket#getInputStream()}/{@link
 * javaoverride.net.HttpURLConnection#getInputStream()}), or from an in-memory byte
