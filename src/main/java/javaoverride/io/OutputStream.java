...
import javaoverride.io.ByteArrayOutputStream;
import javaoverride.io.Closeable;
import javaoverride.io.FilterOutputStream;
import javaoverride.io.Flushable;
import javaoverride.io.IOException;
import javaoverride.io.InputStream;
import javaoverride.io.OutputStreamWriter;
import javaoverride.lang.IndexOutOfBoundsException;
 ...
 * ({@link FileOutputStream}), the network ({@link javaoverride.net.Socket#getOutputStream()}/{@link
 * javaoverride.net.HttpURLConnection#getOutputStream()}), or to an in-memory byte array
 ...
 * type {@link javaoverride.lang.UnsupportedOperationException} instead of being
 * abstract.
 */
