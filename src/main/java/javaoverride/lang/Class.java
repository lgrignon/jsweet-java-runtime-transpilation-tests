...
import javaoverride.lang.reflect.Type;
...
public final class Class<T> implements Type {
	 ...
	 * <p>
	 *
	 * Arrays are not registered in the prototype table and get the class literal
	...
	private Class<?> createClassLiteralForArray(int dimensions) {
		...
		clazz.superclass = castToOverride(Object.class);
		if (dimensions > 1) {
	...
	/**
	 * Install class literal into prototype.clazz field (if type is instantiable)
	 * such that Object.getClass() returning this.clazz returns the literal. Also
	 * stores typeId on class literal for looking up prototypes given a literal.
	 * This is used for deRPC at the moment, but may be used to implement
	...
	// // prototype field.
	// prototype.@javaoverride.lang.Object::___clazz = clazz;
	// };
